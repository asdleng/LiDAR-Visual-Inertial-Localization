...
struct StatesGroup
{
    ...
    {
        StatesGroup a;
        a.rot_end = this->rot_end * Exp(state_add(3, 0), state_add(4, 0), state_add(5, 0));
        a.pos_end = this->pos_end + state_add.block<3, 1>(0, 0);
    ...
    StatesGroup &operator+=(const Matrix<double, DIM_STATE, 1> &state_add)
    {
        this->rot_end = this->rot_end * Exp(state_add(3, 0), state_add(4, 0), state_add(5, 0));
        this->pos_end += state_add.block<3, 1>(0, 0);
    ...
    Matrix<double, DIM_STATE, 1> operator-(const StatesGroup &b)
    {
        ...
        a.block<3, 1>(3, 0) = Log(rotd);
        a.block<3, 1>(0, 0) = this->pos_end - b.pos_end;
